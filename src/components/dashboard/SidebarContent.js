        ...
        return (
            <div className="relative h-100 overflow-hidden flex justify-between flex-column bg-blue white">
                ...
                <div className="flex h4 justify-between ph3 pv4 bt">
                     ...
                     <Link to={'/logout'} className={bottomLinkClass + ' ph2'} style={{paddingTop: '1.25rem'}}><div className={bottomTextClass}><FaSignOut className="pl3 pb1 white f3" /> Logout</div></Link>
                </div>
            </div>
        );
    }
