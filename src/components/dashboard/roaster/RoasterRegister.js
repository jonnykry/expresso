...
class RoasterRegister extends Component {
    render() {
        ...
        return (
            <div>
                <article className="pa4 mw4 mw6-ns center black-80">
                    <div className="f2 tc">Register Roaster Account</div>
                    <form onSubmit={this.props.onHandleSubmit.bind(this)} className="w-100">
                        <div className={headerClass}>Owner Information</div>
                        ...
                        <div className={headerClass}>Store Info</div>
...
export default RoasterRegister;
